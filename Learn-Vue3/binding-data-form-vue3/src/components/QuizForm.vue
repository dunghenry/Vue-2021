            ...
            <div class="form-group">
              <div class="form-item col">
                ...
                <input
                  ...
                  id="name"
                  type="text"
                  placeholder="Tran Dung"
                  v-model="quizOptions.fullName"
                />
              ...
              <div class="form-item col">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="trandungksnb00@gmail.com"
                  v-model="quizOptions.email"
                />
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-4" v-for="option in jobOptions" :key="option.id">
                <div
                  class="block"
                  :style="{
                    backgroundColor: quizOptions.jobs.includes(option.id)
                      ? 'var(--primary)'
                      : '',
                  }"
                >
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      if (
        this.quizOptions.fullName.length < 6 ||
        this.quizOptions.fullName.length > 18
      ) {
        this.error = {
        ...
        this.quizOptions.fullName.length > 5 &&
        this.quizOptions.fullName.length < 19
      ) {
        this.success = {
          text: "Look great!",
          status: true,
